...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "javagap@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "javagap API";

        private String description = "javagap API documentation";
